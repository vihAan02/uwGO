...
WLU manual form ─────────────▶ CourseMeeting[]  (university: "WLU")
                     ...
                     buildWeekPlan({ meetings, home, mondayISO, config }, provider)
                       ...
                       ├─ 1. analyseGaps      which gaps are worth going home for
                       ├─ 2. buildItinerary   the chain of legs those decisions imply (N stops → N+1 legs)
